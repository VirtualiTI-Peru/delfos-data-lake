CREATE OR ALTER PROCEDURE silver.spCanalesMkt_Insert
AS
BEGIN
	...
	BEGIN
		...
		END CATCH
	END
	SELECT @StartDateProc, GETDATE(), 'silver.spCanalesMkt_Insert' AS ProcedureName, @ResultMessage AS LogMessage
END
